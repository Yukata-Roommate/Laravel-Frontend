 ...
 * Simple Clock
 */
export class SimpleClock extends Clock {
    /*----------------------------------------*
     * Render
     *----------------------------------------*/
     ...
     * @type {string}
     */
    betweenYearAndMonthSymbol: string = "-";
     ...
     * @type {string}
     */
    betweenMonthAndDaySymbol: string = "-";
     ...
     * @type {string}
     */
    betweenHourAndMinuteSymbol: string = ":";
     ...
     * @type {string}
     */
    betweenMinuteAndSecondSymbol: string = ":";
