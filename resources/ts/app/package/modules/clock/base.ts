...
import type { DayOfWeekType, DayOfWeekLanguage } from "./dayOfWeek";
...
export abstract class Clock {
     ...
     */
    get dayOfWeekLanguage(): DayOfWeekLanguage {
     ...
     */
    set dayOfWeekLanguage(language: string) {
     ...
     */
    get dayOfWeekType(): DayOfWeekType {
