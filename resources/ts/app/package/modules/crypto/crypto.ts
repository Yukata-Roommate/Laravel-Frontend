...
export class Crypto {
     ...
     * @type {Crypto}
     */
    public static readonly instance: Crypto = new Crypto();
    ...
    public static encrypt(
        ...
        return this.instance.encrypt(data, password, iterations);
    }
    ...
    public static decrypt(
        ...
        return this.instance.decrypt(data, password, iterations);
    }
}
